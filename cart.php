 ...
 session_start();
            // $i= $_SESSION["img"];
             ...
             //array_push($_SESSION["images"],$i);
              $d=array();$name=array();$price=array();
             $p=$_SESSION['mailid'];
             $sql="select cust_id,prod_id from customer_orders where cust_id in (select cust_id from loginpage where email like '%$p%')";
             $result=mysqli_query($con,$sql);
                ...
                while($row=mysqli_fetch_array($result))
                {
                    ...
                    $row2=mysqli_fetch_array($r);
                     array_push($d,$row2[0]);
                    array_push($name,$row2[1]);  array_push($price,$row2[2]);
                }  
        ...
        <div class="col-md-12">
            ...
            <div class="box">
              ...
              for($i=0;$i<count($price);$i++)
                  {
                    echo"
                  <img src='$d[$i]' class='mr-3 dress' alt='...'><br/><br/>";
              }
                  ...
                  foreach($price as $p)
             {
                echo "<h4>$p</h4>";
                  ...
                  for($i=0;$i<count($price);$i++)
                  {
                      echo "<h3>$name[$i]</h3><br/>"; echo "<h4>Rs.$price[$i]</h4><br/><br/><br/><br/><br/>";
                  }
