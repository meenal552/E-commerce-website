...
if(!$result)
      ...
      $em=$_SESSION["mailid"];
      $s="select *from loginpage where email like'%$em%'";
...
<body>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="carttext-align"><h2>MY CART</h2></div>
                <div class="media">
                <div>
              <?php echo"<img src='$i' class='mr-3 dress' alt='...'>";?>
                 
                    
                </div>
              <div class="media-body">
                <h3 class="mt-0"><?php echo"$row[1]";?></h3>
                <h4><?php echo"$row[2]";?></h4>
                  ...
                  <button type="submit" class="btn btn-primary button"><a href="payment.html">Check Out</a></button></div>
            ...
            <div class="box1">
            <h2>PRICE DETAILS</h2>
                <h4>Price:</h4><h5><?php echo"$row[2]";?></h5>
                <h4>Total Quantity:</h4><h5>2</h5>
                <h4>Delivery:</h4><h5><?php echo"$row2[3]";?></h5>
                <h3>Total Payable:</h3><h5><?php echo 2*$row[2];?></h5>
            </div>
        </div>
    </div>
    <div class="row">
