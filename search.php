...
include 'testdb.php';
$search=$_POST['prod'];
$sql="select * from product_details where prod_name like'%$search%'" ;
$desc=array();$name=array();$price=array();$img=array();
$result=mysqli_query($con,$sql);
if(!$result)
    echo " error ".mysqli_error($con);
while($row=mysqli_fetch_array($result)){
    array_push($name,$row[1]);
                    array_push($price,$row[2]);  array_push($desc,$row[3]);
    array_push($img,$row[6]);
        ...
        <div class="col-md-12">
            ...
            <div class="box">
              ...
              for($i=0;$i<count($price);$i++)
                  {
                    echo"
                  <img src='$img[$i]' class='mr-3 dress' alt='...'><br/><br/><br/>";
              }
                  ...
                  foreach($price as $p)
             {
                echo "<h4>$p</h4>";
                  ...
                  for($i=0;$i<count($price);$i++)
                  {
                      echo "<br/><h3>$name[$i]</h3>"; echo "<h4>Rs.$price[$i]</h4>";echo "<h4>$desc[$i]</h4><br/><br/><br/>";
                  }
